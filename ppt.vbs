...
' xzl: use ppPrintCurrent to print the 1st slide. 
' 		use ppPrintAll to print all slides. 
' FrameSlides should be set msoFalse, otherwise cropping tool cannot determine 
'     the correct pdf bounding box.
objPresentation.ExportAsFixedFormat outputFile, ppFixedFormatTypePDF, ppFixedFormatIntentScreen, msoFalse, ppPrintHandoutHorizontalFirst, ppPrintOutputSlides, msoFalse, objPrintOptions.Ranges(1), ppPrintCurrent, "Slideshow Name", False, False, False, False, False
